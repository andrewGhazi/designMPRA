...
Furthermore, t-tests are generally considered robust against minor violations of the normality assumption (Devore 2008). 
...
4. Devore, J. L. (2008). The Two-Sample t Test and Confidence Interval. In Probability and Statistics For Engineering and the Sciences (7th ed., p. 336). Belmont, CA: Thomson Brooks/Cole.
