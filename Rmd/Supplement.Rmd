...
sim_power = data_frame(transcription_shift = seq(-1.5, 1.5, length.out = 50),
...
The two curves are almost exactly the same, showing a difference in theoretical and simulated power of no more than +/- 0.04003 anywhere.
