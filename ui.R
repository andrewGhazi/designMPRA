    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("Create sequences",
                 ...
                 h4('VCFs'),
                 br(),
                 p('Only the CHROM, POS, REF, and ALT columns are used. Note that the input sequence context width is HALF of the total context (e.g. input of 75 yields 150bp of sequence context).'),
                 ...
                 tags$div(
                   tags$ul(
                     ...
                     tags$li('Multiple alternate alleles are not allowed.'),
                 ...
                 h3('Outputs'),
                 p('Once processing has completed, click the download button to download a tab-separated file containing the sequences and other relevant information.'),
                 br(),
